...
<div class="container">
    ...
    <br/>
    <div class="row">            
        <button type="button" class="btn btn-warning pull-right" onclick="document.location.href = '${pageContext.request.contextPath}/admin/addMovie';">New Movie</button>                
    </div>    
                ...
                <tbody>
                    <s:iterator value="%{listType}">
                        <tr>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/admin/update?itemId=<s:property value="movieTypeId"/>"><center><i class="icon-pencil"></i></center></a>
                            </td>
                            <td>
