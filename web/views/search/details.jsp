        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="span6">
                    ...
                    <div class="help-block">
                        <center>
                            <button id="rent" type="button" class="btn btn-large btn-info">Add to Cart</button>
                        </center>
                    </div>
                </div>
            </div>
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="span6">
                    ...
                    <div class="help-block">
                        <center>
                            <button id="buy" rel="A" type="button" class="btn btn-large btn-info">Add to Cart</button>
                        </center>
                    </div>
                </div>
            </div>
...
<input type="hidden" id="actionA" value="${pageContext.request.contextPath}/addCart"/>
<input type="hidden" id="movieId" value="<s:property value="movie.movieId"/>"/>
